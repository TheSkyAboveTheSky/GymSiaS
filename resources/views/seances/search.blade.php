...
@section('content')
<form class="form-inline my-2 my-lg-0"  type="get" action="{{url('/searchseances')}}">
  <input class="form-control mr-sm-2" type="search" name="queryseance"  placeholder="Search" aria-Label="">
